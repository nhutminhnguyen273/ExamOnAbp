...
namespace ExamOnAbp.Shared.Hosting.Microservices.DbMigrations.MongoDb
{
        ...
        where TDbContext : AbpMongoDbContext
    {
        ...
        public virtual async Task CheckAndApplyDatabaseMigrationsAsync()
        {
            await TryAsync(async () =>
            {
                using (CurrentTenant.Change(null))
                {
                    ...
                    {
                        await MigrationDatabaseSchemaAsync();
        ...
        /// </summary>
        protected virtual async Task<bool> MigrationDatabaseSchemaAsync()
        {
            var result = false;
